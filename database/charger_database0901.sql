...
(35, 2, 2, NULL, 'shop_purchase', NULL, 'active', 1, '2025-09-01 10:11:52', '2025-09-01 10:11:52', NULL, NULL, NULL),
...
--
ALTER TABLE `coupons`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '優惠券ID', AUTO_INCREMENT=45;
...
--
ALTER TABLE `shop_orders`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '訂單ID', AUTO_INCREMENT=31;
