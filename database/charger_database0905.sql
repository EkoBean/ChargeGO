...
INSERT INTO `user` (`uid`, `login_id`, `user_name`, `telephone`, `email`, `password`, `hashed_password`, `country`, `address`, `blacklist`, `wallet`, `point`, `total_carbon_footprint`, `credit_card_number`, `credit_card_date`, `status`) VALUES
...
(5, 'abc123', 'user5', '0956874519', 'kkk@g.com', '1234', '03ac674216', 'county9', 'XXXXXXXXXX', 0, 0, 0, 0.0000, '1234567891023456', '12/28', '');
