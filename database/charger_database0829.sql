...
CREATE TABLE `coupons` (
  ...
  `is_expired` tinyint(4) NOT NULL DEFAULT 1 COMMENT '過期狀態(1:尚未過期,2:過期)',
...
--
ALTER TABLE `coupons`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '優惠券ID', AUTO_INCREMENT=23;
...
--
ALTER TABLE `shop_orders`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '訂單ID', AUTO_INCREMENT=9;
